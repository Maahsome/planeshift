...
ID: PSFT-6-20260913-0921-2901BC
Title: Implement Plane API — Projects

## Description

### Work 01: Implement Plane API — Projects

Use this file as the implementation prompt for the Projects slice of `planeshift` (Jira ticket PSFT-2).

#### Prompt

You are an AI coding agent working in the `planeshift` repository. Read `AGENTS.md`, `CONSTITUTION.md`, `ARCHITECTURE.md`, `LOCAL_BUILD.md`, `work/README.md`, and the foundation prompt before editing. This slice depends on the API client foundation.

Implement the Projects resource completely. The scope is the 8 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.
...
- [Create project with template](https://developers.plane.so/api-reference/project/create-project-with-template.md)
...
Implement the project lifecycle, including template creation and the archive/unarchive transitions. Preserve the documented project feature flags and nullable/dynamic project fields.
...
Implementation plan has been generated and saved to [plans/implementation-plan-implement-plane-api-projects.md](../../plans/implementation-plan-implement-plane-api-projects.md)
