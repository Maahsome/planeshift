...
Use this file as the implementation prompt for the Work Item Labels slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Work Item Labels resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.
...
Implement the project work-item label catalog and CRUD operations. Distinguish these labels from project labels, initiative labels, release labels, and customer properties.
