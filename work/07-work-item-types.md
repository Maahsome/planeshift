# Work 07: Implement Plane API — Work Item Types

Use this file as the implementation prompt for the Work Item Types slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Work Item Types resource completely. The scope is the 6 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Work Item Types overview](https://developers.plane.so/api-reference/issue-types/types/overview.md)
- [Create a work item type](https://developers.plane.so/api-reference/issue-types/types/add-issue-type.md)
- [List all work item types](https://developers.plane.so/api-reference/issue-types/types/list-issue-types.md)
- [Retrieve a work item type](https://developers.plane.so/api-reference/issue-types/types/get-issue-type-details.md)
- [Get work item type schema](https://developers.plane.so/api-reference/issue-types/types/get-work-item-type-schema.md)
- [Update a work item type](https://developers.plane.so/api-reference/issue-types/types/update-issue-types.md)
- [Delete a work item type](https://developers.plane.so/api-reference/issue-types/types/delete-issue-type.md)

Implement type CRUD plus schema retrieval. Preserve the distinction between a type’s metadata and its schema/custom-property definition, and keep dynamic schema data lossless.
