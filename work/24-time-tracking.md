# Work 24: Implement Plane API — Time Tracking

Use this file as the implementation prompt for the Time Tracking slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Time Tracking resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Time Tracking overview](https://developers.plane.so/api-reference/worklogs/overview.md)
- [Create a worklog](https://developers.plane.so/api-reference/worklogs/create-worklog.md)
- [List all worklogs for a work item](https://developers.plane.so/api-reference/worklogs/get-worklogs-for-issue.md)
- [Get total time for each work item](https://developers.plane.so/api-reference/worklogs/get-total-time.md)
- [Update a worklog](https://developers.plane.so/api-reference/worklogs/update-worklog.md)
- [Delete a worklog](https://developers.plane.so/api-reference/worklogs/delete-worklog.md)

Implement worklog CRUD, issue/work-item listing, and total-time retrieval. Handle date/time and duration fields without timezone truncation, and preserve the distinction between per-item logs and aggregate totals.
