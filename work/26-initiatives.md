# Work 26: Implement Plane API — Initiatives

Use this file as the implementation prompt for the Initiatives slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Initiatives resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Initiatives overview](https://developers.plane.so/api-reference/initiative/overview.md)
- [Create an initiative](https://developers.plane.so/api-reference/initiative/add-initiative.md)
- [List all initiatives](https://developers.plane.so/api-reference/initiative/list-initiatives.md)
- [Retrieve an initiative](https://developers.plane.so/api-reference/initiative/get-initiative-detail.md)
- [Update an initiative](https://developers.plane.so/api-reference/initiative/update-initiative-detail.md)
- [Delete an initiative](https://developers.plane.so/api-reference/initiative/delete-initiative.md)

Implement initiative CRUD and preserve workspace-level fields, ownership, descriptions, dates, status, and dynamic metadata.
