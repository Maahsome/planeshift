# Work 28: Implement Plane API — Initiative Projects

Use this file as the implementation prompt for the Initiative Projects slice of `planeshift` (Jira ticket PSFT-2).

## Prompt

You are an AI coding agent working in the `planeshift` repository. Read `AGENTS.md`, `CONSTITUTION.md`, `ARCHITECTURE.md`, `LOCAL_BUILD.md`, `work/README.md`, and the foundation prompt before editing. This slice depends on [`26-initiatives.md`](./26-initiatives.md), [`01-projects.md`](./01-projects.md).

Implement the Initiative Projects resource completely. The scope is the 3 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Add projects to initiative](https://developers.plane.so/api-reference/initiative/add-projects-to-initiative.md)
- [List all projects in an initiative](https://developers.plane.so/api-reference/initiative/list-initiative-projects.md)
- [Remove projects from initiative](https://developers.plane.so/api-reference/initiative/remove-projects-from-initiative.md)

Implement initiative/project association operations, including bulk add/remove payloads, stable list pagination, and duplicate/not-found behavior from the API.
