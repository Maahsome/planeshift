# Work 31: Implement Plane API — Project Releases

Use this file as the implementation prompt for the Project Releases slice of `planeshift` (Jira ticket PSFT-2).

## Prompt

You are an AI coding agent working in the `planeshift` repository. Read `AGENTS.md`, `CONSTITUTION.md`, `ARCHITECTURE.md`, `LOCAL_BUILD.md`, `work/README.md`, and the foundation prompt before editing. This slice depends on [`01-projects.md`](./01-projects.md), [`30-releases.md`](./30-releases.md).

Implement the Project Releases resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Create a project release](https://developers.plane.so/api-reference/release/add-project-release.md)
- [List all project releases](https://developers.plane.so/api-reference/release/list-project-releases.md)
- [Retrieve a project release](https://developers.plane.so/api-reference/release/get-project-release-detail.md)
- [Update a project release](https://developers.plane.so/api-reference/release/update-project-release-detail.md)
- [Delete a project release](https://developers.plane.so/api-reference/release/delete-project-release.md)

Implement project-scoped release CRUD separately from workspace releases. Do not conflate the two route shapes or resource identifiers.
