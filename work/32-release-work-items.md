# Work 32: Implement Plane API — Release Work Items

Use this file as the implementation prompt for the Release Work Items slice of `planeshift` (Jira ticket PSFT-2).

## Prompt

You are an AI coding agent working in the `planeshift` repository. Read `AGENTS.md`, `CONSTITUTION.md`, `ARCHITECTURE.md`, `LOCAL_BUILD.md`, `work/README.md`, and the foundation prompt before editing. This slice depends on [`31-project-releases.md`](./31-project-releases.md), [`04-work-items.md`](./04-work-items.md).

Implement the Release Work Items resource completely. The scope is the 3 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Add work items to release](https://developers.plane.so/api-reference/release/add-release-work-items.md)
- [List all work items in a release](https://developers.plane.so/api-reference/release/list-release-work-items.md)
- [Remove work items from release](https://developers.plane.so/api-reference/release/remove-release-work-items.md)

Implement release/work-item association operations, including bulk payloads, paginated listing, and remove semantics.
