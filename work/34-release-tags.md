# Work 34: Implement Plane API — Release Tags

Use this file as the implementation prompt for the Release Tags slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Release Tags resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Create a release tag](https://developers.plane.so/api-reference/release/add-release-tag.md)
- [List all release tags](https://developers.plane.so/api-reference/release/list-release-tags.md)
- [Retrieve a release tag](https://developers.plane.so/api-reference/release/get-release-tag-detail.md)
- [Update a release tag](https://developers.plane.so/api-reference/release/update-release-tag-detail.md)
- [Delete a release tag](https://developers.plane.so/api-reference/release/delete-release-tag.md)

Implement release-tag CRUD with exact tag naming/version rules, release association, pagination, and deletion behavior from the endpoint pages.
