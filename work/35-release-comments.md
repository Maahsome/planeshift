# Work 35: Implement Plane API — Release Comments

Use this file as the implementation prompt for the Release Comments slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Release Comments resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Create a release comment](https://developers.plane.so/api-reference/release/add-release-comment.md)
- [List all release comments](https://developers.plane.so/api-reference/release/list-release-comments.md)
- [Retrieve a release comment](https://developers.plane.so/api-reference/release/get-release-comment-detail.md)
- [Update a release comment](https://developers.plane.so/api-reference/release/update-release-comment-detail.md)
- [Delete a release comment](https://developers.plane.so/api-reference/release/delete-release-comment.md)

Implement release comment CRUD, preserving the documented comment content/access/attachment fields and release-scoped route.
