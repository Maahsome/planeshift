# Work 36: Implement Plane API — Release Links

Use this file as the implementation prompt for the Release Links slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Release Links resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Create a release link](https://developers.plane.so/api-reference/release/add-release-link.md)
- [List all release links](https://developers.plane.so/api-reference/release/list-release-links.md)
- [Retrieve a release link](https://developers.plane.so/api-reference/release/get-release-link-detail.md)
- [Update a release link](https://developers.plane.so/api-reference/release/update-release-link-detail.md)
- [Delete a release link](https://developers.plane.so/api-reference/release/delete-release-link.md)

Implement release link CRUD and preserve URL/title/metadata fields plus the release-scoped route and identifiers.
