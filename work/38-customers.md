# Work 38: Implement Plane API — Customers

Use this file as the implementation prompt for the Customers slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Customers resource completely. The scope is the 8 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Customers overview](https://developers.plane.so/api-reference/customer/overview.md)
- [Create a customer](https://developers.plane.so/api-reference/customer/add-customer.md)
- [Link work items to customer](https://developers.plane.so/api-reference/customer/link-work-items-to-customer.md)
- [List all customers](https://developers.plane.so/api-reference/customer/list-customers.md)
- [Retrieve a customer](https://developers.plane.so/api-reference/customer/get-customer-detail.md)
- [List all customer work items](https://developers.plane.so/api-reference/customer/list-customer-work-items.md)
- [Update a customer](https://developers.plane.so/api-reference/customer/update-customer-detail.md)
- [Unlink work item from customer](https://developers.plane.so/api-reference/customer/unlink-work-item-from-customer.md)
- [Delete a customer](https://developers.plane.so/api-reference/customer/delete-customer.md)

Implement customer CRUD plus work-item link/list/unlink operations. Preserve contact, status, external identifier, and custom property references exactly as documented.
