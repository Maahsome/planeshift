# Work 40: Implement Plane API — Customer Requests

Use this file as the implementation prompt for the Customer Requests slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Customer Requests resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [Create a customer request](https://developers.plane.so/api-reference/customer/add-customer-request.md)
- [List all customer requests](https://developers.plane.so/api-reference/customer/list-customer-requests.md)
- [Retrieve a customer request](https://developers.plane.so/api-reference/customer/get-customer-request-detail.md)
- [Update a customer request](https://developers.plane.so/api-reference/customer/update-customer-request-detail.md)
- [Delete a customer request](https://developers.plane.so/api-reference/customer/delete-customer-request.md)

Implement customer request CRUD and preserve request status, customer/work-item references, descriptions, source metadata, and timestamps.
