# Work 43: Implement Plane API — Teamspace Projects

Use this file as the implementation prompt for the Teamspace Projects slice of `planeshift` (Jira ticket PSFT-2).

## Prompt

You are an AI coding agent working in the `planeshift` repository. Read `AGENTS.md`, `CONSTITUTION.md`, `ARCHITECTURE.md`, `LOCAL_BUILD.md`, `work/README.md`, and the foundation prompt before editing. This slice depends on [`41-teamspaces.md`](./41-teamspaces.md), [`01-projects.md`](./01-projects.md).

Implement the Teamspace Projects resource completely. The scope is the 3 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.

### Documentation to implement

- [List teamspace projects](https://developers.plane.so/api-reference/teamspace/list-teamspace-projects.md)
- [Add projects to teamspace](https://developers.plane.so/api-reference/teamspace/add-projects-to-teamspace.md)
- [Remove projects from teamspace](https://developers.plane.so/api-reference/teamspace/remove-projects-from-teamspace.md)

Implement teamspace/project association list/add/remove operations, including bulk payloads and duplicate/not-found handling.
