...
Use this file as the implementation prompt for the Stickies slice of `planeshift` (Jira ticket PSFT-2).
...
Implement the Stickies resource completely. The scope is the 5 HTTP operations listed below. Do not implement another resource or invent behavior not present in the linked Plane documentation.
...
Implement sticky CRUD, preserving content, color/position, project/workspace references, and any dynamic view metadata in the API schema.
